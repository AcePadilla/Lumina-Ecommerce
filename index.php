...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM items WHERE ItemName LIKE '%$searchTerm%'";
    $result = mysqli_query($conn, $query);
...
<head>
    ...
    <link rel="stylesheet" href="homeNU.css">
   ...
   <main>
      ...
      <div class="context">
         ...
         <p>Discover the freshest additions to our inventory in Our Latest Arrivals where style meets innovation. Stay ahead of trends and elevate your shopping experience with our newest products.</p>
            <div class="shopnow">
                <a href="shoppageNU.php">Shop Now</a>
            </div>
      </div>
      <div class="mockups">
            <ol>
                <li> <img src="pics/mockup2.png" alt=""></li>
                <li> <img src="pics/mockup1.png" alt=""></li>
                <li> <img src="pics/mockup3.png" alt=""></li>
            </ol>
        </div>
