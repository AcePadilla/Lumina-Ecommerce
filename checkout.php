...
<i class="ri-close-line search__close" id="search-close"></i>
   ...
   <main>
<div class="main">
    <form class="checkout-form" action="save_checkout_info.php" method="POST">
        <h1>Checkout</h1>
        <div class="checkout-steps">
            <div class="step active" data-step="Address">Address</div>
            <div class="step" data-step="Shipping">Shipping</div>
            <div class="step" data-step="Payment">Payment</div>
        </div>

        <input type="text" name="firstName" placeholder="First Name" required value="<?php echo isset($existingRow['firstName']) ? htmlspecialchars($existingRow['firstName']) : ''; ?>">
        <input type="text" name="lastName" placeholder="Last Name" required value="<?php echo isset($existingRow['lastName']) ? htmlspecialchars($existingRow['lastName']) : ''; ?>">
        <input type="text" name="address" placeholder="Address" required value="<?php echo isset($existingRow['address']) ? htmlspecialchars($existingRow['address']) : ''; ?>">
        <input type="text" name="city" placeholder="City" required value="<?php echo isset($existingRow['city']) ? htmlspecialchars($existingRow['city']) : ''; ?>">
        <input type="text" name="country" placeholder="Country" required value="<?php echo isset($existingRow['country']) ? htmlspecialchars($existingRow['country']) : ''; ?>">
        <input type="text" name="zipcode" placeholder="Zipcode" required value="<?php echo isset($existingRow['zipcode']) ? htmlspecialchars($existingRow['zipcode']) : ''; ?>">
